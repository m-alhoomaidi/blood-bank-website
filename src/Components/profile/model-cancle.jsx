    ...
    <div>
      ...
      >
        <Box sx={style}>
          ...
          >
            <Typography id="modal-modal-title">الغاء تنشيط الحساب</Typography>
            <IconButton sx={{ marginTop: "-10px" }} onClick={Hand}>
              <CloseIcon />
            </IconButton>{" "}
          </Box>
          <Divider
          ...
          >
            <Typography>هل أنت متأكد من إلغاء تنشيط حسابك؟</Typography>
          </Box>
          <Box
            sx={{
              display: "flex",
  ...
  return (
    <Box>
      <Card sx={{ marginTop: "20px", p: 1 }}>
        <CardHeader title="تنشيط عملية التبرع" sx={{ marginRight: "70px" }} />
        <Grid container spacing={2} justifyContent="center">
          <Grid
            ...
            md={10}
            sx={{
              "& .css-1pxa9xg-MuiAlert-message": { color: "green" },
            }}
          >
            <Alert icon={false} severity="success">
              تفعيل تنشيط حسابك ! <br /> لكي تظهر بياناتك عند البحث عن المتبرع{" "}
            </Alert>
          </Grid>
