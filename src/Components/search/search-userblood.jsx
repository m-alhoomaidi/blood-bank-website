...
export const SearchUserBlood = () => {
  ...
  const SendNotification = async (tokens) => {
    ...
    return await fetch("https://fcm.googleapis.com/fcm/send", {
      ...
      headers: {
        Authorization:
          "key=AAAA38t9Pf8:APA91bHd0hEzCkV3I2p-fNMcOefQ1qPB33maAXXHMdf8fYy-oAkbyBBkGd4qKNR50j8P8QHb0gJwWOG4ejoGpbwaZw526MHofn3kb4HsQfyGW2j5ooAPIxdVtyFSC6wX9-JiAtspHITX",
  ...
  const HandleBloodType = (event, e) => {
    setTypeBlood(e.label);
    setTransion(true);
    setBloodIconShow(true);
  };
  ...
  return (
    <Box sx={{ marginTop: "80px", pt: 2, minHeight: "70vh" }}>
      <Card
        sx={{
          p: 2,
        ...
        <TabContext value={value}>
          ...
          >
            <TabList onChange={handleChange} aria-label="lab API tabs example">
              ...
              />
              <Tab
                label=" نتائج البحث من المراكز الطبية"
                value="2"
                sx={{ marginRight: "50xp" }}
              />
            </TabList>
                ...
                {BloodIconShow ? (
                  <Card
                    sx={{
                      ...
                      marginTop: "10px",
                      boxShadow:
                        "5px 5px 5px rgb(100 116 139 / 6%),5px 5px 20px rgb(100 116 139 / 10%)",
                    }}
                  >
                    {Transion ? (
                      <Grow
